...
<main id="main-content" class="layout__content layout__main" aria-labelledby="archive__project-title">
  ...
  <div class="container">
    ...
    if ( have_posts() ) : ?>
    <header class="archive-header site-header" aria-labelledby="archive__project-title">
      <?php
